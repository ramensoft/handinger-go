...
<a href="https://pkg.go.dev/github.com/stainless-sdks/handinger-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/handinger-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/handinger-go" // imported as handinger
)
```
...
```sh
go get -u 'github.com/stainless-sdks/handinger-go@v0.0.1'
```
...
The handinger library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/handinger-go/option).
...
`*handinger.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `handinger.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/handinger-go/issues) with questions, bugs, or suggestions.
